      ...
      sendForm(firstName, lastName, email, phoneNumber, message)
        .then((res) => {
          if (res === "sent") {
            ...
            document.getElementById("loading").classList = "loading hide";
        ...
        <div id="form">
          <Container>
            <Form noValidate onSubmit={submitHandler}>
              <div className="mb-1">
                <span className="validationError">{responseError}</span>
              </div>
              <Row>
                {/* First Name */}
                <Col md={6} sm={12}>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <span className="validationError">{firstNameError}</span>
                  </Form.Group>
                </Col>
                ...
                <Col md={6} sm={12} xs={12}>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <span className="validationError">{lastNameError}</span>
                  </Form.Group>
                </Col>
                ...
                <Col md={6} sm={12} xs={12}>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <span className="validationError">{phoneError}</span>
                  </Form.Group>
                </Col>
                ...
                <Col md={12} sm={12} xs={12}>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <span className="validationError">{messageError}</span>
                  </Form.Group>
                </Col>
                <Col md={12} sm={12} xs={12}>
                  <Form.Group className="mb-3">
                    <ReCAPTCHA
                      ...
                      onChange={reCaptcha}
                    />
                    <span className="validationError">{captchaError}</span>
                  </Form.Group>
                </Col>
            ...
            <Image src={loading} id="loading" className="loading hide" />
          </Container>
        </div>
      </div>
        ...
        <Row className="align-items-center mx-auto">
          <Col md={{ span: 12, offset: 5 }} sm={{ span: 12, offset: 5 }}>
            <div>
              ...
              <p className="lead justify text-dark">I will be in touch soon.</p>
            </div>
          </Col>
        </Row>
      </Container>
